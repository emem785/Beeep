...
import 'package:beep/Screens/Authentication/Register/setup_beep/setup_beep_one.dart';
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Consumer<UxControl>(builder: (context, chooseplan, _) {
                    return CommonButton(
                      text: 'Continue',
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => SetupPageOne(opt: opt)));
                        chooseplan.setPlan(opt);
                      },
                    );
                  }),
                ),
